    ...
    if (protocolMsg) {
        switch (protocolMsg.type) {
            ...
            case index_js_1.proto.Message.ProtocolMessage.Type.PEER_DATA_OPERATION_REQUEST_RESPONSE_MESSAGE:
                ...
                if (response) {
                    ...
                    for (const result of peerDataOperationResult) {
                        ...
                        if (retryResponse) {
                            const webMessageInfo = (0, proto_utils_1.decodeAndHydrate)(index_js_1.proto.WebMessageInfo, retryResponse.webMessageInfoBytes);
            ...
            case index_js_1.proto.Message.ProtocolMessage.Type.LID_MIGRATION_MAPPING_SYNC:
                ...
                const { pnToLidMappings, chatDbMigrationTimestamp } = (0, proto_utils_1.decodeAndHydrate)(index_js_1.proto.LIDMigrationMappingSyncPayload, encodedPayload);
