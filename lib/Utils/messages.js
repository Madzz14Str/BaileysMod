...
const prepareWAMessageMedia = async (message, options) => {
    ...
    if (cacheableKey) {
        ...
        if (mediaBuff) {
            ...
            const obj = (0, proto_utils_1.decodeAndHydrate)(index_js_1.proto.Message, mediaBuff);
...
const generateForwardMessageContent = (message, forceForward) => {
    ...
    content = (0, proto_utils_1.decodeAndHydrate)(index_js_1.proto.Message, index_js_1.proto.Message.encode(content).finish());
